...
{
    public class FundUsageRepository : GenericRepository<FundUsage>, IFundUsageRepository
    {
        public FundUsageRepository(EvCoOwnershipDbContext context) : base(context)
        {
        }
    }
}