...
{
    public class VehicleStationRepository : GenericRepository<VehicleStation>, IVehicleStationRepository
    {
        public VehicleStationRepository(EvCoOwnershipDbContext context) : base(context)
        {
        }
    }
}