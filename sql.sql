...
CREATE TABLE driving_licenses (
	...
	-- 0=Pending, 1=Verified, 2=Rejected, 3=Expired
	created_at TIMESTAMP DEFAULT NOW(),
	updated_at TIMESTAMP DEFAULT NOW()
);
...
CREATE TABLE vehicle_verification_history (
	...
	notes TEXT,
	-- Detailed notes from the verification process
	images_json TEXT,
	-- Array of image URLs from verification process
	created_at TIMESTAMP DEFAULT NOW()
);
CREATE TABLE vehicle_co_owners (
	...
	status_enum INTEGER DEFAULT 0,
	-- contract_status_enum: 0=active, 1=pending, 2=terminated
	created_at TIMESTAMP DEFAULT NOW(),
	updated_at TIMESTAMP DEFAULT NOW()
);
